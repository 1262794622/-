...
public class CMDTest {
    ...
    String dataPath = "F:\\自动化测试\\大作业\\ClassicAutomatedTesting\\"+projectName+"\\data\\";
    String projectTarget = "F:\\自动化测试\\大作业\\ClassicAutomatedTesting\\"+projectName+"\\target\\";
    String changeInfoPath = "F:\\自动化测试\\大作业\\ClassicAutomatedTesting\\"+projectName+"\\data\\change_info.txt";
